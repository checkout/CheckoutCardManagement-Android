...
internal class CheckoutEventLogger
    @VisibleForTesting
    internal constructor(
        ...
        fun log(
            ...
            logger.logEvent(logEventUtils.buildEvent(event, startedAt, extraProperties = additionalInfo))
        }
        ...
        private companion object {
            private fun Environment.toLoggingEnvironment(): LoggerEnvironment =
                when (this) {
